...
@Code
    ViewData("Title") = "Empaque - Ingresar información de la orden"
...
<div id="main-ContIzquierda">
    ...
    @Using Html.BeginForm()
        ...
        @<div class="row">
            ...
            <span class="Span-c"> @Html.TextBoxFor(Function(m) m.ScanDate, New With {.Value = Now()}) </span>
            
            <span class="Span-b"><span class="pcenter">Scan By</span></span>
