...
<h2 class="TituloFormulario">Proceso Facturación de Ordenes </h2>
...
<!-- Inicia diseño del formulario -->
<h2 class="TituloFormulario">Listado de Ordenes Pendientes Facturar</h2>
...
@grid.GetHtml(columns:=grid.Columns( _
    ...
    grid.Column("Facturacion", "Facturación", format:=Function(item) Html.ActionLink("Facturar", "invoice", "facturacion", New With {.OrderID = item.OrderID}, vbNull), style:="Link_") _
))
