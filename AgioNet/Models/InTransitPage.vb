...
Public Class PDFHojaViajera
    ...
    Protected Overrides Sub Create()
        ...
        Dim prop As New FontProp(def, 8, Color.Black)
        Dim page As New Page(Me)
        page_Cur.AddRT_MM(200, 20, New RepString(fontProp, "Hoja de ingreso"))
        Dim stream As Stream = New FileStream(Me._rutaLogo, FileMode.Open, FileAccess.Read)
        page_Cur.AddMM(20, 30, New RepImageMM(stream, 40, Double.NaN))
        stream = New FileStream(Me._rutaBarCode, FileMode.Open, FileAccess.Read)

        page_Cur.AddMM(100, 55, New RepImageMM(stream, 100, Double.NaN))
        page_Cur.AddLT_MM(20, 45, New RepString(prop2, "Número de Orden:"))
        page_Cur.AddLT_MM(55, 45, New RepString(prop, Model.Orderid))
        page_Cur.AddLT_MM(150, 55, New RepString(prop, Model.Orderid))
        page_Cur.AddLT_MM(20, 65, New RepString(prop2, "Número de Serie:"))
        page_Cur.AddLT_MM(55, 65, New RepString(prop, Model.SerialNo))
        page_Cur.AddLT_MM(20, 72, New RepString(prop2, "Número de Parte:"))
        page_Cur.AddLT_MM(55, 72, New RepString(prop, Model.PartNo))
        page_Cur.AddLT_MM(20, 79, New RepString(prop2, "Modelo:"))
        page_Cur.AddLT_MM(55, 79, New RepString(prop, Model.Model))
        page_Cur.AddLT_MM(20, 86, New RepString(prop2, "Track No:"))
        page_Cur.AddLT_MM(55, 86, New RepString(prop, Model.TrackNo))
        page_Cur.AddLT_MM(20, 93, New RepString(prop2, "Fecha Ingreso: "))
        page_Cur.AddLT_MM(55, 93, New RepString(prop, Model.ScanDate))
        page_Cur.AddLT_MM(110, 93, New RepString(prop2, "Ingresado por: "))
        page_Cur.AddLT_MM(145, 93, New RepString(prop, Model.ScanBy))
        page_Cur.AddLT_MM(20, 100, New RepString(prop2, "Tipo Empaque: "))
        page_Cur.AddLT_MM(55, 100, New RepString(prop, Model.PackType))
        page_Cur.AddLT_MM(110, 100, New RepString(prop2, "Empaque Dañado: "))
        page_Cur.AddLT_MM(145, 100, New RepString(prop, Model.PackDamage))
        page_Cur.AddLT_MM(20, 107, New RepString(prop2, "Daño no documentado: "))
        page_Cur.AddLT_MM(65, 107, New RepString(prop, Model.NonDoucumentDamage))
        page_Cur.AddLT_MM(110, 107, New RepString(prop2, "Empacado Correctamente "))
        page_Cur.AddLT_MM(165, 107, New RepString(prop, Model.CorrectPack))
        page_Cur.AddLT_MM(20, 114, New RepString(prop2, "Accesorios: "))
        page_Cur.AddLT_MM(55, 114, New RepString(prop, Model.Accesories))
        page_Cur.AddLT_MM(20, 135, New RepString(prop2, "Cosmetico / Observaciones: "))
        page_Cur.AddLT_MM(55, 142, New RepString(prop, Model.Cosmetic))
        page_Cur.AddLT_MM(20, 156, New RepString(prop2, "Garantía: "))
        page_Cur.AddLT_MM(55, 156, New RepString(prop, Model.Warranty))
        page_Cur.AddLT_MM(110, 156, New RepString(prop2, "Re repair: "))
        page_Cur.AddLT_MM(145, 156, New RepString(prop, Model.ReRepair))
        page_Cur.AddLT_MM(20, 163, New RepString(prop2, "Comentarios: "))
        page_Cur.AddLT_MM(55, 163, New RepString(prop, Model.Comment))
        page_Cur.AddLT_MM(20, 177, New RepString(prop2, "Falla presentada: "))
        page_Cur.AddLT_MM(55, 177, New RepString(prop, Model.ReportedFailure))
    End Sub
