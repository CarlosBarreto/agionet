...
Module agGlobals
    ...
    Public Function getCreateOrderEmailFormat(OrderID As String, model As CreateOrderModel) As String
        ...
        builder.AppendLine("    <title>Se ha creado una nueva orden de reparaci\x00f3n</title> ")
        builder.AppendLine("</head> ")
        ...
        builder.AppendLine("                    Este correo es para informarte que se ha creado la Orden de reparacion <b>[ " + OrderID + "-01 ]</b> y ser\x00e1 atendida de inmediato. Por lo pronto, aqu\x00ed tienes los datos que se han registrado en nuestro sistema ")
        ...
        builder.AppendLine("                        <td><b>N\x00famero de Orden:</b></td> ")
        ...
        builder.AppendLine("                    <tr> ")
        builder.AppendLine("                        <td colspan=""1""></td> ")
        builder.AppendLine("                        <td><b>Direcci\x00f3n:</b></td> ")
        ...
        builder.AppendLine("                        <td><b>Pa\x00eds:</b></td> ")
        ...
        builder.AppendLine("                    <tr> ")
        builder.AppendLine("                        <td colspan=""1"">&nbsp;</td> ")
        builder.AppendLine("                        <td><b>Descripci\x00f3n:</b></td> ")
