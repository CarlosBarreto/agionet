...
<h2 class="TituloFormulario">Ingenieria - Asignación de un usuario para la Estación</h2>
@Using Ajax.BeginForm("asignarusuario", "ingenieria", New AjaxOptions With {.UpdateTargetId = "tab-content"})
    @<div id="Formulario">       
        <div class="row">
