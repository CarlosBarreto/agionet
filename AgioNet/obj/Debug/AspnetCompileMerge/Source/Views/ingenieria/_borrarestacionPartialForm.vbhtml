...
<h2 class="TituloFormulario">Ingenieria - Eliminar Estación</h2>
@Using Ajax.BeginForm("borrarestacion", "ingenieria", New AjaxOptions With {.UpdateTargetId = "tab-content"})
    @<div id="Formulario">       
        <div class="row">
