...
@grid.GetHtml(columns:=grid.Columns( _
                   ...
                   grid.Column(format:=Function(item) Html.ActionLink("Hoja individual", "hoja_individual", "logistica", New With {.OrderID = item.OrderID}, vbNull)) _
))

@Html.ActionLink("Generar reporte en excel", "GenerateExcel", "diagnostico",  new with { .target = "_blank" })
